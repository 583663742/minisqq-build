...
__attribute__((unused)) static void dumpPSKeys(void) {
    ...
    NSArray *uins = @[@"YOUR_MAIN_UIN", @"YOUR_UIN_2", @"YOUR_UIN_3"]; // 使用前替换为真实QQ号
